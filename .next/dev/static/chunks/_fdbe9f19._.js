...
function SettingsPage() {
    ...
    const authUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redux$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "SettingsPage.useAppSelector[authUser]": (state)=>state.auth.user
    }["SettingsPage.useAppSelector[authUser]"]);
    ...
    const [updateProfile, { isLoading: isUpdating }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redux$2f$api$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUpdateProfileMutation"])();
    ...
    const initials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SettingsPage.useMemo[initials]": ()=>{
            const nameOrEmail = profile.name || profile.email || "";
            const parts = nameOrEmail.trim().split(/\s+/);
            if (parts.length === 0) return "U";
            const letters = parts.slice(0, 2).map({
                "SettingsPage.useMemo[initials].letters": (p)=>p[0]?.toUpperCase()
            }["SettingsPage.useMemo[initials].letters"]).join("");
            return letters || "U";
        }
    }["SettingsPage.useMemo[initials]"], [
        profile.name,
    ...
    const userAvatarUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SettingsPage.useMemo[userAvatarUrl]": ()=>{
    ...
    const handleSave = async ()=>{
        try {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redux$2f$features$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])(updatedUser));
            toast({
...
_s(SettingsPage, "LKSjK3DWl+Z1LNa/C4CqMdN1zbU=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redux$2f$api$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUpdateProfileMutation"]
    ];
});
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=_fdbe9f19._.js.map